...
def DiT_S_2(**kwargs):
    return DiffusionTransformer(depth=8, hidden_size=512, patch_size=2, num_heads=8, **kwargs)

def DiT_S_4(**kwargs):
    return DiffusionTransformer(depth=8, hidden_size=512, patch_size=4, num_heads=8, **kwargs)

def DiT_S_8(**kwargs):
    return DiffusionTransformer(depth=8, hidden_size=512, patch_size=8, num_heads=8, **kwargs)
